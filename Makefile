...
format:  ## run autoformatting with black
	python -m black action_react/ setup.py
...
annotate:  ## run type checking
	python -m mypy ./action_react

#########
# TESTS #
#########
test: ## clean and run unit tests
	python -m pytest -v action_react/tests

coverage:  ## clean and run unit tests with coverage
	python -m pytest -v action_react/tests --cov=action_react --cov-branch --cov-fail-under=50 --cov-report term-missing
